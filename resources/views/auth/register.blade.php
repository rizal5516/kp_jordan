...
<head>
    ...
    <title>Register Page Peminjaman Lab Teknik Komputer</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ route('register') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Teknik Komputer</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form class="mb-3" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="name" class="form-control" id="name" name="name"
                                    placeholder="Enter your nama" autofocus />
                            </div>
                            <div class="mb-3">
